...
def save_to_storage_from_array_list(x,storage_dir,image_prefix,update_progress,progress):
    ...
    for i in range(len(xin)):
        ...
        if update_progress == True:
            ...
            progress['curr_message'] = str(progress['curr_message']) + '..about ' + str(curr_prog_percent) + '% through'
...
def protomatebeta_extract_blocks_for_aop_v1(inlist,progress):
    ...
    for i in range(len(inlist)):
        ...
        #kmimg,cen,dv,labels = protomatebeta_recurr_kmeans_v1(kmimg,125,125,localisation_factor)
...
def api_create_new_patterns(task_id,selected_style_names,progress):
    ...
    progress['curr_message'] = 'Getting theme images from storage..'
    ...
    progress['curr_message'] = 'Saving built patterns for display..'
    ...
    progress['curr_message'] = 'Saving core colors for display..'
    ...
    progress['curr_message'] = 'Saving pattern maps for later use..'
    ...
    progress['curr_message'] = 'Retrieving selected stylings for generation..'
    ...
    progress['curr_message'] = 'Saving stylings and categories for generation..'
    ...
    progress['curr_message'] = 'All Done.'
...
def api_create_textures(task_id,picked_ind_string,progress):
    ...
    progress['curr_step'] = 1
    progress['total_step'] = 5
    progress['curr_message'] = 'Loading saved patterns..'
    ...
    progress['curr_step'] = 2
    progress['total_step'] = 5
    progress['curr_message'] = 'Building textures..'
    print('2. At textures..')
    ...
    progress['curr_step'] = 3
    progress['total_step'] = 5
    progress['curr_message'] = 'Saving textures..stripes'
    ...
    progress['curr_step'] = 4
    progress['total_step'] = 5
    progress['curr_message'] = 'Saving textures..checks'
...
#    try:
    ...
    progress['curr_step'] = 1
    progress['total_step'] = 9
    progress['curr_message'] = 'Loading stylings..'
    storage_address = 'gs://ven-ml-project.appspot.com/' + str(task_id) + '/numpy/np_linemarkings.npy'
    f = BytesIO(file_io.read_file_to_string(storage_address, binary_mode=True))
    lines = np.load(f)
    print('Got lines..')
    ...
    progress['curr_step'] = 2
    progress['total_step'] = 9
    progress['curr_message'] = 'Loading segments..'
    storage_address = 'gs://ven-ml-project.appspot.com/' + str(task_id) + '/numpy/np_segments.npy'
    f = BytesIO(file_io.read_file_to_string(storage_address, binary_mode=True))
    segs = np.load(f)
    print('Got segs..')
    ...
    progress['curr_step'] = 3
    progress['total_step'] = 9
    progress['curr_message'] = 'Loading patterns..'
    storage_address = 'gs://ven-ml-project.appspot.com/' + str(task_id) + '/numpy/np_all_patterns.npy'
    f = BytesIO(file_io.read_file_to_string(storage_address, binary_mode=True))
    ...
    progress['curr_step'] = 4
    progress['total_step'] = 9
    progress['curr_message'] = 'Loading colors..'
    storage_address = 'gs://ven-ml-project.appspot.com/' + str(task_id) + '/numpy/np_all_colors.npy'
    f = BytesIO(file_io.read_file_to_string(storage_address, binary_mode=True))
    colors = np.load(f)
    print('Got colors..')
    ...
    progress['curr_step'] = 5
    progress['total_step'] = 9
    progress['curr_message'] = 'Loading checks..'
    storage_address = 'gs://ven-ml-project.appspot.com/' + str(task_id) + '/numpy/np_checks.npy'
    f = BytesIO(file_io.read_file_to_string(storage_address, binary_mode=True))
    checks = np.load(f)
    print('Got checks..')
    ...
    progress['curr_step'] = 6
    progress['total_step'] = 9
    progress['curr_message'] = 'Loading stripes..'
    storage_address = 'gs://ven-ml-project.appspot.com/' + str(task_id) + '/numpy/np_stripes.npy'
    f = BytesIO(file_io.read_file_to_string(storage_address, binary_mode=True))
    stripes = np.load(f)
    print('Got stripes..')
    ...
    progress['curr_step'] = 7
    progress['total_step'] = 9
    progress['curr_message'] = 'Generating ideas..'
    ...
    progress['curr_step'] = 8
    progress['total_step'] = 9
    progress['curr_message'] = 'Saving ideas..'
